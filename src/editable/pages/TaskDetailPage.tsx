      ...
      <header className="border-b border-black/20">
        <div className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-3 border-t-4 border-black pt-4 text-[11px] font-black uppercase tracking-[0.16em]">
            <span className="bg-[var(--slot4-accent)] px-3 py-2 text-black">{categoryOf(post, 'Media distribution')}</span>
          </div>
          <h1 className="mt-6 max-w-6xl text-5xl font-black uppercase leading-[0.94] tracking-[-0.045em] sm:text-6xl lg:text-[5.5rem]">{post.title}</h1>
        </div>
      </header>
...
function RelatedCard({ task, post }: { task: TaskKey; post: SitePost }) {
  ...
  return (
    <Link href={buildPostUrl(task, post.slug)} className="group flex gap-3 border-t border-black/15 py-3 transition hover:text-black">
